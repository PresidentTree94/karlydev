export default function Accordian({
  ...
  return (
    <div className="border-b border-stone-100 last:border-b-0 group">
      <button className="flex justify-between items-center w-full gap-4 py-5 cursor-pointer text-left" onClick={onToggle}>
        <span className="font-medium text-stone-800 transition-colors group-hover:text-amber-700 flex-1">{faq.question}</span>
